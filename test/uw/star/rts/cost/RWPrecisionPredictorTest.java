...
public class RWPrecisionPredictorTest extends CodeCoverageTest {
	...
	public void testGetPredicatedPercetageOfTestCaseSelected() {
		...
		assertEquals("selection rate",0.388,RWPrecisionPredictor.predictSelectionRate(codeCoverage,tca),0.01);
	    ...
	    assertEquals("selection rate",0.66,RWPrecisionPredictor3.predictSelectionRate(codeCoverage,regressionSuite,2),0.01);
	}
}
